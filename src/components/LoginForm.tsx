  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="form-container bg-form-bg p-8 rounded-xl w-full max-w-md space-y-6">
        <p className="title text-2xl font-bold text-center text-black">Login</p>
        ...
        <div className="social-message flex items-center space-x-3">
          ...
          <p className="text-sm text-text-gray">Login with social accounts</p>
          <div className="flex-1 h-px bg-input-border"></div>
        </div>
        ...
        <div className="signup flex justify-center items-center space-x-1">
          <p className="text-xs text-text-light">Don't have an account?</p>
          <button 
